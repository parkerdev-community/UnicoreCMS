<template>
  <section>
    ...
    <div class="px-4">
      ...
      <p>
        Информация о балансе внутриигровой валюты на серверах. Перенос, перевод и пополненение осуществляется во вкладке “ПОПОЛНЕНИЕ И
        ПЕРЕВОД”
      </p>
      <div class="row mt-2" v-if="money && money.length">
