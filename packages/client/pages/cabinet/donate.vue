    ...
    <div class="row px-3">
      <div class="col-xl-6 px-4">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <vs-select :loading="!servers.length" :key="servers.length" placeholder="Выберите сервер" v-model="donate.server_id" style="max-width: 150px;">
            <vs-option
        ...
        <div class="d-flex justify-content-between align-items-center mt-4">
          ...
          <vs-button v-if="donate.server" :to="`/donate/${donate.server.id}`" class="d-none d-xl-block m-0" size="small"><i class="bx bx-link me-1"></i> Подробнее</vs-button>
        </div>
      ...
      <div class="col px-4 pt-4 pt-xl-0">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <vs-select :loading="!servers.length" :key="servers.length" placeholder="Выберите сервер" v-model="permission.server_id" style="max-width: 150px;">
            <vs-option
              v-for="(server, index) in servers"
              :key="server.id"
              :label="server.name"
