  ...
  <div class="grid">
    <div class="col-12 lg:col-6 xl:col-3">
      <div class="card mb-0">
        ...
        <span class="text-green-500 font-medium"
          >+{{ $_.get(stats, 'purchases.days[6].count', '...') }}</span
        >
    ...
    <div class="col-12 lg:col-6 xl:col-3">
      <div class="card mb-0">
        ...
        <span class="text-green-500 font-medium"
          >+{{
            formatCurrency($_.get(stats, 'payments.months[11].amount', 0))
          }}</span
        >
    ...
    <div class="col-12 lg:col-6 xl:col-3">
      <div class="card mb-0">
        ...
        <span class="text-green-500 font-medium"
          >+{{ $_.get(stats, 'users.days[6].count', '...') }}</span
        >
        <span class="text-500">сегодня</span>
      </div>
    </div>
    <div class="col-12 lg:col-6 xl:col-3">
      <div class="card mb-0">
        ...
        <span class="text-green-500 font-medium"
          >{{ $_.get(stats, 'online_records.days[6].amount', '...') }}
        </span>
        <span class="text-500">сегодня</span>
      </div>
    </div>
  ...
  methods: {
    ...
    daysCharts() {
      const range = Array.from(
        this.$moment
          .range(
            this.$moment().subtract(6, 'day').startOf('day').local(),
            this.$moment().local()
          )
          .by('day')
      )
    ...
    monthsCharts() {
      const range = Array.from(
        this.$moment
          .range(
            this.$moment().subtract(11, 'month').startOf('month').local(),
            this.$moment().local()
          )
          .by('month')
      )
